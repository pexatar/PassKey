 ...
 * Receives fill commands from the background service worker.
 *
...
chrome.runtime.onMessage.addListener((msg, sender, sendResponse) => {
  if (msg.type === 'fill-fields') {
    ...
    sendResponse({ success, error: success ? null : 'no-form-detected' });
  }
...
chrome.runtime.sendMessage({ type: 'update-badge', url: location.href }).catch(() => {});
